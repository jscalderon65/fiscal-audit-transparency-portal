      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="space-y-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight text-white drop-shadow-sm text-balance text-center sm:text-left">
              {info.title}
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl font-light flex items-center gap-3 text-slate-300 justify-center sm:justify-start">
              {info.subtitle}
            </p>
          </div>
